...
Real-time web search capability for 智码 GLM Code using Playwright-controlled browser automation.

## Overview

The Web Search Skill enables 智码 GLM Code to perform live web searches using Google and Bing, with automatic fallback when one provider is unavailable. The skill uses Playwright to control a local Chrome browser instance, making all operations transparent and observable.
...
This skill is part of the 智码 GLM Code project. For issues or suggestions:
