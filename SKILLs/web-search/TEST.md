...
This guide walks through testing the entire Web Search Skill integration with 智码 GLM Code.

## Prerequisites

1. 智码 GLM Code built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with 智码 GLM Code.

**Steps:**

1. Start 智码 GLM Code in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of 智码 GLM Code launch.
...
1. Open a terminal while 智码 GLM Code is running
...
**Objective:** Verify graceful shutdown of services when 智码 GLM Code quits.

**Steps:**

1. With 智码 GLM Code running and searches completed, quit the application
...
1. Start 智码 GLM Code (ensure headless is false in config)
...
- ✅ Server auto-starts with 智码 GLM Code
