...
智码 GLM Code 已经基于 `lobsterai-server` 的 HTML 分享系统支持 HTML、图片、SVG、Office/PDF 文件分享。现有链路为：
...
构建方式参考 `src/main/share-preview/README.md` 中 Office bundle 的方式，使用 智码 GLM Code 客户端已有依赖打包：
