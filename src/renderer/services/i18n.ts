...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    codingPlanTab: '套餐管理',
    codingPlanLoginTitle: '登录智码套餐',
    codingPlanOfficialProvider: '官方服务',
    codingPlanLoginDescription: '使用 glmcoding.cn 的邮箱和密码查看并配置 Coding Plan。',
    codingPlanEmail: '邮箱',
    codingPlanEmailPlaceholder: '请输入 glmcoding.cn 邮箱',
    codingPlanPassword: '密码',
    codingPlanPasswordPlaceholder: '请输入密码',
    codingPlanLogin: '登录',
    codingPlanLoggingIn: '登录中...',
    codingPlanRegister: '注册新账号',
    codingPlanRegisterShort: '注册',
    codingPlanLoginRequiredFields: '请输入邮箱和密码',
    codingPlanInvalidCredentials: '邮箱或密码不正确',
    codingPlanNetworkError: '无法连接 glmcoding.cn，请检查网络后重试',
    codingPlanSessionExpired: '登录状态已过期，请重新登录',
    codingPlanLoadFailed: '套餐信息加载失败，请稍后重试',
    codingPlanLoading: '正在加载套餐信息...',
    codingPlanRefresh: '刷新套餐信息',
    codingPlanLogout: '退出登录',
    codingPlanMyPlans: '我的套餐',
    codingPlanViewPlans: '查看可用套餐',
    codingPlanNoPlans: '当前账号暂无可用套餐',
    codingPlanNoExpiry: '长期有效',
    codingPlanExpiresAt: '有效期至',
    codingPlanCalls: '调用次数',
    codingPlanTotalQuota: '总额度',
    codingPlanFiveHourWindow: '5 小时限额',
    codingPlanWeeklyWindow: '每周限额',
    codingPlanMonthlyWindow: '每月限额',
    codingPlanResetsAt: '重置时间',
    codingPlanNoKeys: '该套餐暂未绑定 API Key',
    codingPlanConfigure: '一键配置',
    codingPlanConfiguring: '配置中...',
    codingPlanConfigured: '已配置',
    codingPlanUnboundKeys: '未绑定套餐的 Key',
    codingPlanUnboundKeyName: '未绑定套餐',
    codingPlanConfigureSuccess: '智码套餐已配置，可立即选择套餐模型使用',
    codingPlanConfigureFailed: '智码套餐配置失败，请稍后重试',
    codingPlanKeyRejected: '该 API Key 无法获取模型，请检查套餐状态',
    codingPlanSecureStorageUnavailable: '系统安全存储当前不可用，无法安全保存套餐凭据',
    codingPlanCredentialManagedHint: '套餐凭据由主进程和系统安全存储托管，请前往“套餐管理”更换配置。',
    shortcuts: '快捷键',
    about: '关于',
    aboutVersion: '版本',
    aboutContactEmail: '官方网站',
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「智码 GLM Code 外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 智码 GLM Code 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 智码 GLM Code 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    copied: '已复制',
    copyrightHolder: '智码 GLM 科技 版权所有',
    ...
    shortcutOpenCowork: '打开 智码 GLM Code',
    ...
    shortcutDescNewChat: '开始一个新的 智码 GLM Code 任务',
    shortcutDescFocusPrompt: '跳回 智码 GLM Code 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 智码 GLM Code 任务视图',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 智码 GLM Code Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    artifactPreviewCardLobsterBrowser: '智码 GLM Code 浏览器',
    artifactPreviewCardOpenInLobsterBrowser: '在智码 GLM Code 浏览器中打开',
    ...
    coworkWorkingDirectoryHint: '智码 GLM Code 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 智码 GLM Code 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 智码 GLM Code 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '智码 GLM Code 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkCodingOptimization: '编程增强',
    coworkCodingOptimizationDefault: '新会话默认开启',
    coworkCodingOptimizationDescription:
      '为新会话启用代码库理解、工程化实现、调试和验证提示。每个会话仍可在聊天输入区单独关闭。',
    coworkCodingOptimizationEnable: '开启编程增强',
    coworkCodingOptimizationDisable: '关闭编程增强',
    coworkCodingOptimizationEnabledHint:
      '编程增强已开启：强化代码实现、调试、重构和测试。关闭后更适合普通 Agent 任务。',
    coworkCodingOptimizationDisabledHint:
      '编程增强已关闭：当前更适合普通 Agent 任务。开启后将强化代码实现、调试、重构和测试。',
    coworkCodingOptimizationUpdateFailed: '编程增强状态更新失败，请重试。',
    ...
    openClawDataBackupBlockingTitle: '正在备份 智码 GLM Code 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 智码 GLM Code 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 智码 GLM Code 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 智码 GLM Code 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '智码 GLM Code 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '智码 GLM Code 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 智码 GLM Code，你的全场景办公 Agent',
    ...
    coworkGoalInputPlaceholder: '智码 GLM Code 应继续朝哪个目标努力？',
    ...
    coworkThinkingMode: '思考模式',
    coworkThinkingModeWithLevel: '思考模式：{level}',
    coworkThinkingUpdateFailed: '思考强度设置失败，请稍后重试。',
    coworkThinkingLevelOff: '关闭',
    coworkThinkingLevelOn: '开启',
    coworkThinkingLevelMinimal: '极简',
    coworkThinkingLevelLow: '低',
    coworkThinkingLevelMedium: '中',
    coworkThinkingLevelHigh: '高',
    coworkThinkingLevelXHigh: '超高',
    coworkThinkingLevelAdaptive: '自适应',
    coworkThinkingLevelMax: '最高',
    ...
    coworkErrorModelSourceLobsterAIPlan: '智码 GLM Code 套餐',
    ...
    skillMarketplaceLoadMore: '加载更多',
    skillMarketplaceLoadingMore: '加载中...',
    skillMarketplaceLoadMoreFailed: '加载更多技能失败，请稍后重试',
    skillMarketplaceRefreshFailed: '刷新技能市场失败，请稍后重试',
    skillMarketplaceSearchFailed: '搜索 ClawHub 失败，请稍后重试',
    skillCategoryAll: '全部',
    skillInstall: '安装',
    skillInstalling: '安装中',
    ...
    browserWebAccessDescription: '使用 智码 GLM Code 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: '智码 GLM Code 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后仅作为 智码 GLM Code 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: '智码 GLM Code 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 智码 GLM Code 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 智码 GLM Code 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 智码 GLM Code 发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进 智码 GLM Code',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '智码 GLM Code 服务说明',
    privacyDialogDesc: '在使用智码 GLM Code 之前，请仔细阅读{link}并确认。',
    privacyDialogLinkText: '智码 GLM Code 服务说明',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用智码 GLM Code',
    welcomeSubtitle: '面向真实项目的智能编码与全场景 Agent',
    welcomePromo: '连接你的模型，开始高效创作',
    welcomeLogin: '登录',
  ...
  en: {
    ...
    codingPlanTab: 'Plan Management',
    codingPlanLoginTitle: 'Sign in to Coding Plan',
    codingPlanOfficialProvider: 'Official service',
    codingPlanLoginDescription: 'Use your glmcoding.cn email and password to view and configure plans.',
    codingPlanEmail: 'Email',
    codingPlanEmailPlaceholder: 'Enter your glmcoding.cn email',
    codingPlanPassword: 'Password',
    codingPlanPasswordPlaceholder: 'Enter your password',
    codingPlanLogin: 'Sign in',
    codingPlanLoggingIn: 'Signing in...',
    codingPlanRegister: 'Create account',
    codingPlanRegisterShort: 'Register',
    codingPlanLoginRequiredFields: 'Enter your email and password',
    codingPlanInvalidCredentials: 'Incorrect email or password',
    codingPlanNetworkError: 'Cannot connect to glmcoding.cn. Check your network and try again.',
    codingPlanSessionExpired: 'Your session has expired. Sign in again.',
    codingPlanLoadFailed: 'Failed to load plan information. Try again later.',
    codingPlanLoading: 'Loading plan information...',
    codingPlanRefresh: 'Refresh plan information',
    codingPlanLogout: 'Sign out',
    codingPlanMyPlans: 'My plans',
    codingPlanViewPlans: 'View plans',
    codingPlanNoPlans: 'This account has no active plans',
    codingPlanNoExpiry: 'No expiration',
    codingPlanExpiresAt: 'Expires',
    codingPlanCalls: 'Calls',
    codingPlanTotalQuota: 'Total quota',
    codingPlanFiveHourWindow: '5-hour limit',
    codingPlanWeeklyWindow: 'Weekly limit',
    codingPlanMonthlyWindow: 'Monthly limit',
    codingPlanResetsAt: 'Resets',
    codingPlanNoKeys: 'No API key is bound to this plan',
    codingPlanConfigure: 'Configure',
    codingPlanConfiguring: 'Configuring...',
    codingPlanConfigured: 'Configured',
    codingPlanUnboundKeys: 'Keys without a plan',
    codingPlanUnboundKeyName: 'Unbound key',
    codingPlanConfigureSuccess: 'Coding Plan is configured and ready to use',
    codingPlanConfigureFailed: 'Failed to configure Coding Plan. Try again later.',
    codingPlanKeyRejected: 'This API key could not load models. Check the plan status.',
    codingPlanSecureStorageUnavailable:
      'Secure operating-system storage is unavailable, so the plan credential cannot be saved safely.',
    codingPlanCredentialManagedHint:
      'This credential is managed by the main process and secure operating-system storage. Use Plan Management to replace it.',
    shortcuts: 'Shortcuts',
    about: 'About',
    aboutVersion: 'Version',
    aboutContactEmail: 'Official Website',
    ...
    aiSkinCreationGuide: 'Use “Customize 智码 GLM Code” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only 智码 GLM Code-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the 智码 GLM Code UI',
    ...
    copied: 'Copied',
    copyrightHolder: '智码 GLM 科技. All rights reserved.',
    ...
    shortcutScopeHint:
      'Shortcuts only run while the 智码 GLM Code window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutOpenCowork: 'Open 智码 GLM Code',
    ...
    shortcutDescNewChat: 'Start a new 智码 GLM Code task',
    shortcutDescFocusPrompt: 'Return to 智码 GLM Code and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the 智码 GLM Code task view',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit 智码 GLM Code Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    siteQuotaChooseHint: 'Choose an online site. 智码 GLM Code will never stop one automatically.',
    ...
    artifactPreviewCardLobsterBrowser: '智码 GLM Code Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in 智码 GLM Code Browser',
    ...
    // 智码 GLM Code
    cowork: '智码 GLM Code',
    coworkSettings: '智码 GLM Code Settings',
    ...
    coworkWorkingDirectoryHint: '智码 GLM Code will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for 智码 GLM Code...',
    coworkSystemPromptHint: "Optional system prompt to customize 智码 GLM Code's behavior",
    ...
    coworkModelSettingsHint:
      '智码 GLM Code uses the current model and provider configuration from Model Settings.',
    ...
    coworkCodingOptimization: 'Coding boost',
    coworkCodingOptimizationDefault: 'Enable for new chats',
    coworkCodingOptimizationDescription:
      'Applies repository-aware implementation, debugging, and verification guidance to new chats. You can still turn it off per chat.',
    coworkCodingOptimizationEnable: 'Enable coding boost',
    coworkCodingOptimizationDisable: 'Disable coding boost',
    coworkCodingOptimizationEnabledHint:
      'Coding boost is on: code implementation, debugging, refactoring, and testing are enhanced. Turn it off for general agent tasks.',
    coworkCodingOptimizationDisabledHint:
      'Coding boost is off: this mode is better for general agent tasks. Turn it on to enhance implementation, debugging, refactoring, and testing.',
    coworkCodingOptimizationUpdateFailed: 'Failed to update coding boost. Please try again.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up 智码 GLM Code data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import 智码 GLM Code data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import 智码 GLM Code data backup?',
    openClawDataMigrationConfirmDesc:
    ...
    coworkConfigSaveFailed: 'Failed to save 智码 GLM Code settings. Please try again.',
    ...
    coworkPermissionDescription: '智码 GLM Code is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: '智码 GLM Code needs your input',
    ...
    coworkHomeTagline: "I'm 智码 GLM Code, your all-in-one office agent",
    ...
    coworkGoalInputPlaceholder: 'What goal should 智码 GLM Code keep working toward?',
    ...
    coworkThinkingMode: 'Thinking mode',
    coworkThinkingModeWithLevel: 'Thinking mode: {level}',
    coworkThinkingUpdateFailed: 'Failed to update thinking intensity. Please try again.',
    coworkThinkingLevelOff: 'Off',
    coworkThinkingLevelOn: 'On',
    coworkThinkingLevelMinimal: 'Minimal',
    coworkThinkingLevelLow: 'Low',
    coworkThinkingLevelMedium: 'Medium',
    coworkThinkingLevelHigh: 'High',
    coworkThinkingLevelXHigh: 'Extra high',
    coworkThinkingLevelAdaptive: 'Adaptive',
    coworkThinkingLevelMax: 'Maximum',
    ...
    coworkErrorModelSourceLobsterAIPlan: '智码 GLM Code plan',
    ...
    skillMarketplaceLoadMore: 'Load more',
    skillMarketplaceLoadingMore: 'Loading...',
    skillMarketplaceLoadMoreFailed: 'Failed to load more skills. Please try again.',
    skillMarketplaceRefreshFailed: 'Failed to refresh the marketplace. Please try again.',
    skillMarketplaceSearchFailed: 'Failed to search ClawHub. Please try again.',
    ...
    browserWebAccessDescription: 'Use the 智码 GLM Code separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription:
      '智码 GLM Code starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored for 智码 GLM Code, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: '智码 GLM Code will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means 智码 GLM Code will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means 智码 GLM Code can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow 智码 GLM Code to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve 智码 GLM Code',
    usageAnalyticsEnabledDescription:
    ...
    // Privacy dialog
    privacyDialogTitle: '智码 GLM Code Service Information',
    privacyDialogDesc:
      'Before using 智码 GLM Code, please read the {link} and confirm.',
    privacyDialogLinkText: '智码 GLM Code Service Information',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to 智码 GLM Code',
    welcomeSubtitle: 'An intelligent coding and general-purpose Agent for real projects',
    welcomePromo: 'Connect your model and start creating',
    welcomeLogin: 'Login',
